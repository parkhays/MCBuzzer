...
pyinstaller --onefile --windowed --add-data "resources/main_banner.jpg:./resources" --add-data "LICENSE:." --add-data "resources/ABOUT.txt:./resources" --add-data "resources/main_logo1.ico:./resources" Source/mcbuzzer.py
